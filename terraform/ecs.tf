...
resource "aws_ecs_task_definition" "ahmad_task" {
  ...
  execution_role_arn = "arn:aws:iam::373317459749:role/ecs_fargate_execution_role"
  task_role_arn      = "arn:aws:iam::373317459749:role/ecs_fargate_execution_role"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "DATABASE_HOST",     value = aws_db_instance.ahmad_db.address },
